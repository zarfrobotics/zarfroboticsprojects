...
- Automatic folder organization by date/time (`/videos/YYYY_MM_DD/HH00-HH00/`)
...
1. After booting, open the ESPCam HTML file.

2. On first launch, enter your name and the camera IP address.
